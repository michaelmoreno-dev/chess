...
// $(pieces.pawn.dna).addClass('black pawn').attr('draggable', 'true').appendTo(`.file-6.rank-6`)
...
$(pieces.king.dna).addClass('black king').appendTo(`.file-5.rank-8`)
$(pieces.queen.dna).addClass('black queen').appendTo(`.file-4.rank-8`)
